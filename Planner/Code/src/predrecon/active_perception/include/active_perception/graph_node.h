...
public:
  ...
  // Prediction global cost and search path
  static double search_globalPath(const Vector3d& p1, const Vector3d& p2, vector<Vector3d>& path);
  static double compute_globalCost(const Vector3d& p1, const Vector3d& p2, const double& y1, const double& y2,
                            const Vector3d& v1, const double& yd1, vector<Vector3d>& path);
  // Local graph search costFunc
  double localCostTo(const ViewNode::Ptr& node);
  static double LocalCost(const Vector3d& p1, const Vector3d& p2, const double& y1, const double& y2, 
  ...
  double vis_ratio_ref_, vis_ratio_src_;
