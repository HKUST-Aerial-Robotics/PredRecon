...
#include </home/albert/UAV_Planning/fuel_airsim/src/fuel_planner/path_searching/include/path_searching/matrix_hash.h>
...
public:
  ...
  int global_search(const Eigen::Vector3d& start_pt, const Eigen::Vector3d& end_pt);
  int local_search(const Eigen::Vector3d& start_pt, const Eigen::Vector3d& end_pt);
...
private:
  ...
  int getInternal(const Eigen::Vector3d& pos, const int& step);
  int getInfOcc(const Eigen::Vector3d& pos, const int& step);
